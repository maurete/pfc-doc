...
%
\begin{align}
  \SE \tab = \frac{\VP}{\VP+\FN}, \tab \SP \tab = \frac{\VN}{\VN+\FP}.
\end{align}
%
...
%
\begin{align}
    \T{Precisión} \tab\tab \PR \tab=\frac{\VP}{\VP+\FP},\\
    \T{Exactitud} \tab\tab \AC \tab=\frac{\VP+\VN}{\VP+\FP+\VN+\FN},\\
    \T{Valor-F}   \tab\tab \T{\textsl{F}} \tab=\frac{\PR\cdot{}\SE}{\PR+\SE}, \\
    \parbox{4cm}{Coeficiente de correlación de Matthews} \tab\tab
