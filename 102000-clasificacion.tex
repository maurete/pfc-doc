...
secuencias de \premirna{s} aplicando las técnicas de aprendizaje
supervisado de la \e{máquina de vectores de soporte} \cite{svm} y
del \e{perceptrón multicapa} \cite{mlp1,mlp2}.
