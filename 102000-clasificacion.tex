...
secuencias de \premirna{s} mediante las técnicas de aprendizaje
supervisado de \e{máquinas de vectores de soporte} \cite{svm}, la más
ampliamente utilizada en el área, y el \e{perceptrón multicapa}
