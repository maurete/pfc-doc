...
\begin{scope}[node distance=1cm and 1.2cm]
...
\node[annot] at ($ (ua.west) + (-1,0.1) $) {Acción\\manual};
\node[annot] at ($ (production.west) + (-1,-0.1) $) {Acción\\manual};
\node[annot] at ($ (capacity.west) + (-0.5,1) $) {Acción\\manual};
