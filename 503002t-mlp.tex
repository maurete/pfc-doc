...
\begin{table}[h]
  ...
  \caption{\captionStyle
    ...
    entrenamiento.
    Los valores presentados corresponden a la media de las cinco
    repeticiones efectuadas con semillas aleatorias diferentes.
    El número indicado con ${\pm}$ corresponde a la desviación
    estándar correspondiente en cada caso.
  }
  %% \sisetup{
  %%   table-format = 2.1(2)
  %% }
