...
capa de entrada
%% Para simplicidad en la exposición, se asume que los
%% índices $i$ de las neuronas en la capa de salida coinciden con los del
%% vector de salida $\hat{\yy}$, de modo que $s_i=\hat{y}_i$.
La
...
conjunto de entrenamiento, denominada también \e{riesgo empírico},
viene dada por
%
