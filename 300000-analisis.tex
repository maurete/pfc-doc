\chapter{3 Análisis de la organización}
...
3h-15h \\ \hline
\end{tabular}
\e{Tabla 1.1 Análisis del flujo de valor para el proceso de
...
\\ \hline
\end{tabular}
\e{Tabla 1.2 Análisis del flujo de valor para el proceso de
  entrega de un nuevo requerimiento.}
