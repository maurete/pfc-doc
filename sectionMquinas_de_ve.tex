...
hiperplano en $Z$ denominado \e{hiperplano de separación}.
...
hiperplano de separación \e{óptimo} que maximiza la distancia a los
...
$|d_i|=1$.  Estos $\zz_i$ se denominan \e{vectores de soporte}, y los
hiperplanos $\ww^T\zz+b=\pm1$ que contienen los vectores de soporte
conforman el \e{margen} del clasificador.
...
denominados \e{multiplicadores de Lagrange}. Utilizando el funcional
...
Cuando se tienen dos vectores $\vv,\ww\in{}Z$ definidos en términos
