...
secuencia. En la Figura \ref{fig:horquilla} se representa en forma
...
el ejemplo de la Figura \ref{fig:horquilla}, en el reino animal la estructura
secundaria típica de un pre-miRNA conforma una especie de
\e{horquilla} \cite{bartel116}\cite{sewer}.
