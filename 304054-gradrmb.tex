...
\cite{bonnans-shapiro}, siempre que las restricciones del problema de optimización no dependan de
los hiperparámetros. En el caso $\rho_M$ este teorema no aplica, ya que
...
\end{split}\end{align}
%
Reemplazando $\Balpha$ por $\bar{Balpha}$, $\rho_M$ se escribe
%
\begin{align}
