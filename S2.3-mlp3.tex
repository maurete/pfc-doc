La \e{función de activación} es una función no lineal que ``aplasta''
...
En la \refer{mlp5} se asume que los valores $\dpar{E}{s_k}{}$ para todas
...
para las unidades en la capas pecedentes según la \refer{mlp5}.  Dicho de
