...
entrenamiento y prueba del método \e{microPred}.  Los ejemplos de
clase positiva se obtienen de la versión 12.0 de la base de datos
\e{miRBase}. Para los ejemplos de clase negativa se utilizan dos fuentes,
la base de datos \e{CODING} y una base de datos curada por los
autores, denominada \e{other human ncRNAs}, que contiene en total 754
...
la base de datos \e{CODING} y 96 de \e{other human ncrnas}, manteniendo la
...
\e{miRBase} (clase positiva), 7416 ejemplos de \e{CODING} (clase
negativa), y 658 ejemplos de \e{other human ncRNAs} (clase negativa).