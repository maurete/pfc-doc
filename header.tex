...
%% % TeX Gyre Heros (estilo Helvetica)
...
% fontspec - tipografias otf/ttf con xetex/luatex
\usepackage{fontspec}
...
%% %       argumento opcional. No compatible (creo) con xetex/luatex
%% \usepackage[spanish,es-tabla,english]{babel}

%% % inputenc define la codificación de caracteres del código fuente, acá utf8.
%% % no usar con xetex/luatex (ya traen soporte nativo)
%% \usepackage[utf8]{inputenc}

% polyglossia similar a babel pero compatible con xetex/luatex
\usepackage{polyglossia}
\setdefaultlanguage{spanish}

% layout ----------------------------------------------------------------------

% relsize provee comandos para tamaños de fuente relativos
\usepackage{relsize}
...
% colortbl permite cambiar colores en tabulars
\usepackage{colortbl}

% graphicx me da el comando \includegraphics para insertar imágenes (?)
\usepackage{graphicx}

%% % pstricks me da un entorno pstricks y comandos que uso dentro de
...
% Para "combinar" celdas en tablas
\usepackage{multirow}

%Para mejorar cuadros, figuras, etc
\usepackage{float}
...
%% {
%%     name=latex,
%%     description={LaTeX (short for Lamport TeX) is a document
%%       preparation system. The user has to think about only the content
%%       to put in the document and the software will take care of the
%%       formatting. }
%% }

%% % tabulars mejorados (no mantenido desde 2011!)
%% \usepackage{tabu}

% para crear apéndice
% \usepackage[header,titletoc,title]{appendix}

% para insertar pdfs externos dentro del documento(apéndice)
\usepackage{pdfpages}
...
% usar biblatex cuando el documento es pdf
\iflatexml
...
\definecolor{grisclaro}	{cmyk}{0,0,0,.15}

% columna gris clara y centrada
\newcolumntype{g}{>{\columncolor{grisclaro}}c}

% ajustes de formato ----------------------------------------------------------

% ajustar fuente de citas
...
% estilo para tablas
\newcommand{\tableStyle}{
\iflatexml\else\relsize{-0.5}\center\sffamily\fi
}

% estilo para pie de graficos
% fuente de las figuras
\iflatexml\else\setkomafont{caption}{\relsize{-0.5}}\fi
\newcommand{\captionStyle}{
%\iflatexml\else\relsize{-0.5}\fi
}
