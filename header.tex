%
% opciones para el compilador rubber
% rubber: shell_escape
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\tikzexternalize % genera PDFs con las figuras embebidas
%% \usepackage{pgfkeys}
%% \usepackage{pgfgantt}
...
\newcommand{\deltamirbase}{{$\mathbf{\mathsf{\Delta}}$miRBase}}
...
% dataset
\newcommand{\dset}[1]{%
\iflatexml{\bfseries #1}\else\ifpdf\ssf{#1}\fi\fi
}
