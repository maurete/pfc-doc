...
\iflatexml
\newcommand{\hl}[1]{\textcolor{purple}{\bfseries #1}}
\else
\usepackage{soulutf8}
\fi
...
\iflatexml
\newcommand{\citeauthor}[1]{(\emph{cita al autor {#1}})}
\else
\usepackage[square,comma,numbers,sort&compress]{natbib}
\fi

\iflatexml
\newcommand{\autoref}[1]{Fig/Ecuación/etc. \ref{#1}}
\else
\usepackage{hyperref}
...
%
%
\newcommand{\nt}{\iflatexml\textrm{nt}\else\si{nt}\fi}
